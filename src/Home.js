...
import conf from "../src/assets/confg.jpg";
      ...
      <div className="relative h-screen ">
        ...
        <div className="lg:flex lg:pt-20 flex-col items-center justify-center relative z-10 px-6 md:max-w-[90vw] mx-auto">
          ...
          <div className=" flex flex-col items-center justify-center pb-8">
            <h1 className="text-[50px] md:text-[80px] text-white font-bold pt-12 font-serif">
              ConnectNow
            </h1>
          </div>
          ...
          >
            <div className=" flex flex-col justify-center items-center">
              <label className="text-[30px] md:text-[40px] font-bold pt-6 font-serif">
                Enter Room Code
              </label>
              <input
                type="text"
            ...
            <button
              type="submit"
              className=" bg-blue-500 hover:bg-blue-400 duration-100 ease-out font-bold w-[5rem] md:w-[7rem] rounded-full py-[5px] md:py-[7px] mt-2 md:mt-4 font-serif"
            >
              Go
            </button>
          </form>
